...
//  end;
  ...
  public
    ...
    procedure CheckManagedDstSrc(Proc: TIDProcedure; Instruction: TILInstruction);
...
procedure TNPUnit.CheckManagedDstSrc(Proc: TIDProcedure; Instruction: TILInstruction);
{var
  ILCode: TILCode;
  Dst: TIDExpression;
