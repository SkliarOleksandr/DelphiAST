...
begin
  ...
  begin
    ...
    if not Assigned(ANextOverload) then
...
begin
  ...
  begin
    ...
    if not Result and (ASrcType.DataTypeID = ADstType.DataTypeID) then
      case ASrcType.DataTypeID of
        dtDynArray, dtOpenArray: Result := SameTypes(TIDArray(ASrcType).ElementDataType,
